...
if ($update) {
	$sql = $connection->query("SELECT * FROM sepeda WHERE sepeda='$_GET[key]'");
	$row = $sql->fetch_assoc();
}
	    ...
	    <div class="panel panel-<?= ($update) ? "warning" : "info" ?>">
	        ...
	        <div class="panel-body">
	            <form action="<?=$_SERVER['REQUEST_URI']?>" method="POST" enctype="multipart/form-data">
	                ...
	                <?php if ($update): ?>
										<a href="?page=sepeda" class="btn btn-info btn-block">Batal</a>
									<?php endif; ?>
	            </form>
	        </div>
	    </div>
	                        ...
	                        <tr>
	                            ...
	                            <td class="hidden-print">
	                                <div class="btn-group">
	                                    ...
	                                    <a href="?page=sepeda&action=update&key=<?=$row['id_sepeda']?>" class="btn btn-warning btn-xs">Edit</a>
	                                    <a href="?page=sepeda&action=delete&key=<?=$row['id_sepeda']?>" class="btn btn-danger btn-xs">Hapus</a>
	                                </div>
	                            </td>
	                        </tr>
	                        <?php endwhile ?>
